...
- Validate against planner/scribe acceptance criteria and applicable domain contracts.
...
Handoff contract:
- Inputs required: implementation diff, planner ticket, scribe subtask, and relevant contracts.
