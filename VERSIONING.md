...
- Git tags - `git tag -l`
- GitHub Releases - https://github.com/alto9/kube9-operator/releases
...
git commit -m "feat: add CLI query interface #minor"

# Major bump (0.0.1 → 1.0.0)
git commit -m "feat: complete rewrite in TypeScript #major"
